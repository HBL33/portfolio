...
require_once './php/includes/header-confidentialite.php';
?>

<!-- START CONTACT -->
<?php
require_once './php/includes/contact.php';
?>
<section id="politique">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="title">Politique <br><strong>de confidentialité</strong></h2>
                <hr>
            </div>
            ...
            <div class="col-md-12 col-sm-12">
                <p class="text-md-start">
                    ...
                    Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à dev@bonnaudherve.fr.</br>
                </p>
            </div>
            <?php
